...
var UrlController = (function () {
    ...
    UrlController.shorten = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                Url_1.default.create(req.query.url, function (err, data) {
                    if (err) {
                        console.error(err);
    ...
    UrlController.get = function (req, res) {
        if (!req.params.id) {
            return res.status(400).json({
                error: 'You must pass the id of the url as a slug'
            });
        }
        Url_1.default.get(req.params.id, function (err, data) {
